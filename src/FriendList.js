...
const FriendList = (signalRHub) =>
{
    ...
    const toggleDropdown = () => {
      ...
      const handleConfirmRemove = async () => {
        try {
            ...
            const fetchData = await fetch(`https://localhost:7190/api/Connections/DeleteFromFriends?userId=${localStorage.getItem('userId')}&friendId=${removeId}`, {
                method: 'DELETE',
                headers: {
      ...
      const handleRemoveRequest = async (id)=> {
        try {
            const fetchData = await fetch(`https://localhost:7190/api/RequestConnection/CancelRequestConnection?idRequest=${id}`,{
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
    ...
    useEffect(() => {
        ...
        const dummyRequests = async () =>{
            try {
                ...
                const fetchData = await fetch(`https://localhost:7190/api/RequestConnection/GetConnections?userId=${localStorage.getItem('userId')}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        const dummyFriendsList = async ()=>{
            try {
                const fetchData = await fetch(`https://localhost:7190/api/Connections/UserConnection?userId=${localStorage.getItem('userId')}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        const dummyOtherUsers = async () => {
            try {
                const fetchData = await fetch(`https://localhost:7190/api/RequestConnection/GetOtherConnections?userId=${localStorage.getItem('userId')}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const handleAcceptRequest = async(connectionId)=>{
        ...
        try {
            const fetchData = await fetch(`https://localhost:7190/api/RequestConnection/AcceptRequest?Id=${connectionId}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
