            ...
            <Row className='justify-content-center align-items-center'>
              <Col className='text-center'>
                ...
                <p className='lead'>
                  ...
                  needs. From finding experienced doctors to booking
                  appointments, we provide comprehensive solutions to ensure
                  your well-being.
                </p>
              </Col>
            </Row>
              ...
              <Col md={4}>
                <Card className='mb-4 bg-primary text-white rounded'>
                  <Card.Body>
                    ...
                    <Button variant='outline-light' href='/find-doctor'>
                      Find Now
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={4}>
                <Card className='mb-4 bg-primary text-white rounded'>
                  <Card.Body>
                    ...
                    <hr className='bg-white' />
                    <Card.Text>
                      Easily schedule appointments with your preferred
                      healthcare providers.
                    </Card.Text>
                    <Button variant='outline-light' href='/appointments'>
                      Book Now
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={4}>
                <Card className='mb-4 bg-primary text-white rounded'>
                  <Card.Body>
                    ...
                    <hr className='bg-white' />
                    <Card.Text>
                      Get immediate assistance with our 24-hour emergency
                      service.
                    </Card.Text>
                    <Button variant='outline-light' href='/emergency'>
                      Call Now
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={4}>
                <Card className='mb-4 bg-primary text-white rounded'>
                  <Card.Body>
                    ...
                    <hr className='bg-white' />
                    <Card.Text>
                      Schedule online consultations with our healthcare
                      professionals.
                    </Card.Text>
                    <Button variant='outline-light' href='/consultations'>
                      Get Started
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={4}>
                <Card className='mb-4 bg-primary text-white rounded'>
                  <Card.Body>
                    ...
                    <hr className='bg-white' />
                    <Card.Text>
                      Maintain your health with regular check-ups by our
                      experts.
                    </Card.Text>
                    <Button variant='outline-light' href='/check-ups'>
                      Learn More
                    </Button>
                  </Card.Body>
                </Card>
              ...
              <Col md={4}>
                <Card className='mb-4 bg-primary text-white rounded'>
                  <Card.Body>
                    ...
                    <Button variant='outline-light' href='/education'>
                      Explore
                    </Button>
                  </Card.Body>
                </Card>
            ...
            <div className='col-md-3'>
              <div className='card text-center bg-primary text-white'>
                <div className='card-body'>
                  ...
                  <h3>20 Vite</h3>{' '}
                  {/* Vendosni numrin mesatar të viteve të përvojës këtu */}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='container' style={{ height: '100%' }}>
          <Row className='justify-content-center align-items-center '>
            <Col className='text-center'>
              ...
              <hr className='bg-primary' />
              <Button variant='primary' href='/register-patient'>
                Register Now
              </Button>
            </Col>
          </Row>
