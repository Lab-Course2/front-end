...
const Sidebar = ({ userRole }) => {
  ...
  return (
    <>
      <div
        className='d-flex flex-column flex-shrink-0 p-3 bg-transparent'
        style={{ width: '80px' }}
      >
        <button
          className='btn btn-primary rounded-circle d-block d-md-block mb-2'
          style={{ padding: '0px' }}
              ...
              <div className='list-group mt-3'>
                <Link
                  ...
                  className={`list-group-item py-2 ${
                    location.pathname === '/clinic-dashboard' ? 'active' : ''
                  }`}
                  onClick={handleOffCanvasToggle}
                >
                ...
                <Link
                  to='/consultations'
                  className={`list-group-item py-2 ${
                    location.pathname === '/consultations' ? 'active' : ''
                  }`}
                  onClick={handleOffCanvasToggle}
                >
                  <i className='bi bi-house fs-4 me-2'></i>
                ...
                <Link
                  to='/doctor-list'
                  className={`list-group-item py-2 ${
                    location.pathname === '/doctor-list' ? 'active' : ''
                  }`}
                  onClick={handleOffCanvasToggle}
                >
                  <i className='bi bi-house fs-4 me-2'></i>
                ...
                <Link
                  to='/clinic-profile'
                  className={`list-group-item py-2 ${
                    location.pathname === '/clinic-profile' ? 'active' : ''
                  }`}
                  onClick={handleOffCanvasToggle}
                >
